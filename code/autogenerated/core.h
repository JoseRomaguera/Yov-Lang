...
void define_core()
{
	...
	// yov: YovInfo
	{
	ObjectDefinition def = obj_def_make("yov", vtype_from_name("YovInfo"), false);
		define_global(def);
	}
	// context: Context
	{
	ObjectDefinition def = obj_def_make("context", vtype_from_name("Context"), false);
		define_global(def);
	}
	// os: OS
	{
	ObjectDefinition def = obj_def_make("os", vtype_from_name("OS"), false);
		define_global(def);
	}
	// calls: CallsContext
	{
	ObjectDefinition def = obj_def_make("calls", vtype_from_name("CallsContext"), false);
		define_global(def);
	}
}
